            ...
            <div className="w-full h-100">
                ...
                <form className="mt-6" action="#" method="POST">
                    <div>
                        ...
                        <input type="email" name="email" id="login-email" placeholder="Enter Email Address" className="w-full px-4 py-3 mt-2 text-grey-700 bg-white border border-grey-500 rounded-md dark:bg-grey-900 dark:text-grey-300 dark:border-grey-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" required/>
                    </div>
                    <div className="mt-4">
                        <label className="block text-grey-700">Password</label>
                        <input type="password" name="password" id="login-password" placeholder="Enter Password" minLength={6} className="w-full px-4 py-3 mt-2 text-grey-700 bg-white border border-grey-500 rounded-md dark:bg-grey-900 dark:text-grey-300 dark:border-grey-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" required/>
                    </div>
                    <div className="text-right mt-2">
                        <a href="#" className="text-sm font-semibold text-grey-700 hover:text-blue-700 focus:text-blue-700">Forgot Password?</a>
                    </div>
                ...
                <div className="my-6 border-grey-300 w-full">
