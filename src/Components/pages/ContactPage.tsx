...
const ContactPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center w-full h-full">
        <div className="relative flex items-top justify-center  bg-transparent dark:bg-gray-900 sm:items-center sm:pt-0">
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2  dark:bg-gray-800 sm:rounded-lg">
                            <h1 className="text-4xl sm:text-5xl text-white dark:text-white font-extrabold tracking-tight animate-pulse">
                                Get in touch
                            </h1>
                            <p className="text-normal text-lg sm:text-2xl font-medium text-gray-100  mt-2">
                        ...
                        <form onSubmit={onFormSubmit} className="p-6 flex flex-col justify-center">
                            ...
                            <div className="mt-2">
                                ...
                                onChange={handleInputChange}
                                className="w-full h-20 px-3 py-2 bg-transparent placeholder-gray-400 font-bold border border-gray-400 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
                                required
                                ></textarea>
                            </div>
