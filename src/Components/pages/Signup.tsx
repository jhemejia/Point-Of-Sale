              ...
              <button onClick={()=>navigate("/")}
                  ...
                  <form className="mt-6" onSubmit={handleFormSubmit}>
                      ...
                      <div className="mt-4">
                          ...
                          <input type="password" onChange={handleChange} value={userData.password} name="password" id="signup-password" placeholder="Enter Password" minLength={6} className="w-full px-4 py-3 mt-2 text-gray-700 bg-white border border-gray-500 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" required/>
                      </div>
                      <div className="text-right block py-4">
                      </div>
                      <AsyncButton isLoading={isLoading} text={"Sign Up"} />
                  </form>
